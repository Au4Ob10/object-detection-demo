...
Future<void> _initializeCamera() async {
  const CameraLensDirection direction = CameraLensDirection.back;
 ...
 Future<dynamic> detect({
  ...
  required Future<dynamic> Function(GoogleVisionImage image)
 detectInImage,
...
Future<dynamic> Function(GoogleVisionImage image)
_getDetectionMethod() {
